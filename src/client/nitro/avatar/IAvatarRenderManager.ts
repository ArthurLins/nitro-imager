...
export interface IAvatarRenderManager extends INitroManager
{
    ...
    createAvatarImage(figure: string, size: string,listener?: Function, effectListener?: IAvatarEffectListener): IAvatarImage;
    downloadAvatarFigure(container: IAvatarFigureContainer, listener: Function): void;
